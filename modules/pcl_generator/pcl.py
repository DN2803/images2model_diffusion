...
class PCL():
    def __init__(self, images_dir, output_dir):
        ...
        with open("camera_options.yaml", "r") as file:
    ...
    def generate(self):
        ...
        images_matching = ImageMatcher(images_path=self.images_dir)
        image_pairs = images_matching.generate_pairs()
        matched_pairs = {}
        matcher = DiffGlue()
        for image_pair in image_pairs: 
            # Feature Matching
            pred = matcher.matching(image_pair)
